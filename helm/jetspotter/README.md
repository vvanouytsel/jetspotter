...
Jetspotter is a simple program that queries the ADS-B API of <a href="https://adsb.fi" target="_blank">adsb.fi</a>, with <a href="https://adsb.lol" target="_blank">adsb.lol</a> as a fallback.
