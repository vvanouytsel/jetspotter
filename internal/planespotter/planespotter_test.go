...
func TestGetImageFromAPI(t *testing.T) {
	...
	expectedImageURL := "https://www.planespotters.net/photo/1449607/g-10-belgium-politiepolice-mcdonnell-douglas-md-900-explorer?utm_source=api"
	image := GetImageFromAPI("44c1e5")
