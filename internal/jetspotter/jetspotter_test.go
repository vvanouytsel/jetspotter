...
func TestGetAltitudeBucket1(t *testing.T) {
	expected := "2500"
	actual := getAltitudeBucket(2400)
	if expected != actual {
		t.Fatalf("expected '%v' to be the same as '%v'", expected, actual)
	}
}

func TestGetAltitudeBucket2(t *testing.T) {
	expected := "0"
	actual := getAltitudeBucket(0)
	if expected != actual {
		t.Fatalf("expected '%v' to be the same as '%v'", expected, actual)
	}
}

func TestGetAltitudeBucket3(t *testing.T) {
	expected := "5000"
	actual := getAltitudeBucket(2785)
	if expected != actual {
		t.Fatalf("expected '%v' to be the same as '%v'", expected, actual)
	}
}

func TestGetAltitudeBucket4(t *testing.T) {
	expected := "40000+"
	actual := getAltitudeBucket(626987)
	if expected != actual {
		t.Fatalf("expected '%v' to be the same as '%v'", expected, actual)
	}
}

func TestGetAltitudeBucket5(t *testing.T) {
	expected := "20000"
	actual := getAltitudeBucket(20000)
	if expected != actual {
		t.Fatalf("expected '%v' to be the same as '%v'", expected, actual)
	}
}
